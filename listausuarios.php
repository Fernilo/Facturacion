    ...
    <div class="row" id="table">
      <div class="col-12 table-responsive">
        <table class="table table-striped table-dark table-hover">
          ...
          <?php
          $sqlPaginador="SELECT COUNT(*) as total_registro FROM usuario WHERE estado=1";
          ...
          $sqlLista="SELECT * FROM usuario u INNER JOIN rol r ON u.rol= r.idrol WHERE estado=1 ORDER BY u.id ASC LIMIT $desde,$por_pagina ";
